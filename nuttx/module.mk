...
EXTRACXXFLAGS = -Wframe-larger-than=1200 -DCONFIG_WCHAR_BUILTIN -I$(SKETCHBOOK)/modules/rtemlib -I$(SKETCHBOOK)/modules/rtemlib/arch/arm/include -I$(MONITOR_FOLDER) -I$(MONITOR_TEST_CASES_FOLDER) -DARM_CM4_FP -D__NUTTX__ -DDEBUG=3 -std=c++0x --verbose -w
