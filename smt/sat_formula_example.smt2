...
(assert (forall ((x Time) (i Time)) (=> (and (>= x 0) (<= x 20)) (ite
...
(assert (forall ((x Time) (i Time)) (=> (and (>= x 0) (<= x 10)) (ite
...
(define-fun indicator ((mk Trace) (mt Time)) Int
	(ite (= (computeprop3 mk mt 3) TVTRUE) 1 0)
)
		
(declare-fun evaleta ((Time) (Time)) Int)
(assert (forall ((x Time) (i Time)) (=> (and (>= x 0) (<= x (+ 0 5) )) (ite
	(and (and (< x (+ 0 5) ) (>= i 0)) (> x i))
...
;(assert (= (tvor (computeUless!1 10 0) (tvlessthan (computeduration 5 0) 2)) TVTRUE) )

(assert (= (computeUless!1 10 0) TVTRUE) )
(assert (= (tvlessthan (computeduration 5 0) 3) TVTRUE) )
